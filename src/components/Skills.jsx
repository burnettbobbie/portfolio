...
const ServiceCard = ({ title}) => (
    ...
    <motion.div
      ...
      <div
        ...
        className="bg-[rgba(255,255,255,0.5)] drop-shadow-2xl h-[100px] shadow-[inset_8px_8px_30px_white] rounded-[20px] p-[35px] flex justify-evenly items-center flex-col"
      >
  ...
  return (
    < >
      ...
      <motion.p
        ...
        className="mt-4 text-white text-[20px] max-w-5xl mx-[10px] leading-[30px]"
      >
