        ...
        <div className="text-white text-center ">
          ...
          <div  className="flex flex-col mt-[6vh] text-left mb-[40vh] xs:mb-[15vh] sm:mb-[0] mx-[15vw]  lg:leading-10">
            ...
            <div className="mt-6 rounded-[20px] shadow-slate-50 shadow-2xl ">
              <div className="bg-[rgba(255,255,255,0.2)] border-b-[10px] bg-gradient-to-br from-zinc-300 to-zinc-900 border-zinc-50 drop-shadow-2xl shadow-[inset_8px_8px_20px_white] rounded-[20px] p-[35px] flex justify-evenly items-center">
