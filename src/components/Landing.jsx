...
const Landing = () => {
  return (
    <>
      ...
      <motion.div initial={{ y: -250, opacity: 0, rotate:60}} animate={{ y: 0, opacity: 1, rotate: -15, transition: { delay:1, duration: 2, ease: easeInOut, type: "spring", bounce: 0.6  } }}  className="rounded-[15px] border-[#767676] border-[4px] hidden md:block scale-100 lg:scale-[1] mt-[-55vh] p-0 shadow-white shadow-[-15px_-15px_150px_10px] rotate-[-40deg] absolute">
