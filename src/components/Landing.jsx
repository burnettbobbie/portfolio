        ...
        <div className="text-white text-center ">
          ...
          <div  className="flex flex-col mt-[6vh] text-left mb-[40vh] xs:mb-[15vh] sm:mb-[0] mx-[15vw]  lg:leading-10">
            ...
            <div className="mt-6 rounded-[20px] shadow-zinc-900  shadow-2xl">
              <div className="bg-[rgba(208,207,207,0.2)] border-b-[3px] bg-gradient-to-bl from-sky-200 via-zinc-500 to-zinc-900 border-zinc-50 drop-shadow-xl shadow-[inset_8px_8px_20px_white] rounded-[20px] p-[35px] flex justify-evenly items-center">
