        ...
        <div className="text-white text-center ">
          ...
          <div  className="flex flex-col mt-[6vh] text-left mb-[40vh] xs:mb-[15vh] sm:mb-[0] mx-[15vw] ">
            ...
            <div className="mt-2 rounded-[20px] shadow-zinc-900  shadow-2xl">
              <div className="border-b-[3px] bg-gradient-to-bl from-indigo-200 via-zinc-700 to-zinc-950 border-zinc-50 drop-shadow-xl shadow-[inset_3px_3px_20px_white] rounded-[20px] pl-10 pr-24 pt-8 pb-8 flex justify-evenly items-center">
